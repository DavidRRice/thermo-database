#!/usr/bin/env python3
"""Convert the manually transcribed Bezacier et al. (2014) Table I ice VI data to PEARL SI units."""

from pathlib import Path
import re

N_A = 6.02214076e23  # mol^-1, exact SI
Z = 10  # H2O formula units per reported crystallographic unit cell; curator-inferred conversion factor.
